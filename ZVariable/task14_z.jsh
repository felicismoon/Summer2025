// for figuring out three equal bins of z. you change the parameters of z for each target (LC, SC, LPb, SPb), until the .getIntegral() for each bin/histogram is about the same
...
// change values of z here until each histogram (hz1, hz2, hz3) all have about the same amount of data in them (.getIntegral() is about the same)
...
// creates histo of invariant mass for lowest bin of z
...
// creates histo of invariant mass for middle bin of z
...
// creates histo of invariant mass for highest bin of z
