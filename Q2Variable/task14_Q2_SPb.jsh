...
// ok
//F1D f4 = new F1D("f4","[amp]*gaus(x,[mean],[sigma])", .7, .86);

//ok
F1D f4 = new F1D("f4","[amp]*gaus(x,[mean],[sigma])", .7, .84);

//F1D f4 = new F1D("f4","[amp]*gaus(x,[mean],[sigma])", .7, .83);
...
F1D f6 = new F1D("f6","[amp]*gaus(x,[mean],[sigma])+[B0]+[B1]*x+[B2]*x*x", .7, .84);

//F1D f6 = new F1D("f6","[amp]*gaus(x,[mean],[sigma])+[B0]+[B1]*x+[B2]*x*x", .6, .95);
...
F1D f8 = new F1D("f8","[amp]*gaus(x,[mean],[sigma])", .69, .84);
...
F1D f10 = new F1D("f10","[amp]*gaus(x,[mean],[sigma])+[B0]+[B1]*x+[B2]*x*x", .65, .9);
...
F1D f11 = new F1D("f11","[amp]*gaus(x,[mean],[sigma])", .7, .82);
