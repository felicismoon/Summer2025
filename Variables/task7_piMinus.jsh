// graphs pi- variables for all of the data
...
H1F hEinE = new H1F("HEinE", noOfBins, 0.0, 10);
hEinE.setTitleX("#pi - per Event");

H1F hEP = new H1F("hEP", noOfBins, 0.0, 10);
hEP.setTitleX("#pi - Momentum");
...
// note: while the variable names say electron, this program is for the pi-
...
while(reader.hasNext()==true){
	 ...
	 Particle electron1 = physEvent.getParticleByPid(-211,0);
