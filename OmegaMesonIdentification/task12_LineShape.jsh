// gets the number of omegas in the peak for each of the four targets with the Line Shape method
...
// for the ec8 graph (hSub), first to get the limits of the peak, use .getDataY until you find the lowest bin of the peak and the highest bin of the peak with the first postive number. Ex: bin 45 is -1, bin 46 is 2. bin 46 is the one you want. then bin 53 is 1, bin 54 is -4. bin 53 is the one you want. then to find the number of omegas in the peak, use hSub.integral with the bins you figured out. Ex: integral(46,53). 
...
// this creates another histogram with the area under the peak of the second gaussian (yellow-orange color). this is the omega peak
...
// this creates another graph of the area under the quadratic (the background)
...
// subtracts the background from the omega peak, creating a histogram with only the omega peak
