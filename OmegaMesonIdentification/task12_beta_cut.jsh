// gets omega peak for all data with pi0 cut, theta cut, deep inelastic scattering cut, and beta cut. Beta cut values from beta_piMinus and beta_piPlus
...
// pi0 values from 4_3. using two sigma here. beta values from beta_piMinus and beta_piPlus
	 if(pi0_mass>=0.09738220586799731&&pi0_mass<=0.16368863413716286&&dBetaM>-0.009610088863792025
&&dBetaM<0.009930203872220556&&dBetaP>-0.011682417283575339&&dBetaP<0.012765139660253026){
...
// three sigma limits for first gaussian fit
