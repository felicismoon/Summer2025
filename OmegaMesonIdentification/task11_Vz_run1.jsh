// creates separate invariant mass (and theta) plots for the carbon solid target and the carbon liquid target, using Vz
...
H1F    hpi1_2 = new H1F("hpi_2"   ,noOfBins,0, 1.5);

H1F    hgamma_2 = new H1F("hgamma_2"   ,noOfBins,0.05, 0.28);

H1F    htheta0_2 = new H1F("htheta0_2"   ,noOfBins,0.0, 1.5);
H1F    htheta1_2 = new H1F("htheta1_2"   ,noOfBins,0.0, 1.5);
...
// Vz cut for the Carbon solid target. Values from task11_Vz.jsh
...
// value of Vz from task11_Vz.jsh for deuterium target (C)
